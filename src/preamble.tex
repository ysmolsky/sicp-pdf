...
\usepackage[papersize={120mm,170mm},
            top=1mm,
            bottom=6mm,
            left=1mm,
            right=1mm,
...
\definecolor{LinkRed}{HTML}{4d0d12}
\hypersetup{
...
\definecolor{SchemeDark}    {HTML} {000000}
...
\renewcommand{\LettrineFontHook}{\rmfamily\mdseries\color{SchemeDark}}
...
{\lstset{basicstyle=\ttfamily\small\color{SchemeDark},#1}}
{}

\lstnewenvironment{smallscheme}[1][]
{\lstset{basicstyle=\ttfamily\footnotesize\color{SchemeDark},#1}}
{}
